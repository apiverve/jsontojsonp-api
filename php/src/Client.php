...
namespace APIVerve\Jsontojsonp;
...
/**
 * Client for the JSON to JSONP API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/jsontojsonp?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/jsontojsonp';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\JsontojsonpClient] {$message}\n";
        }
    }
}
