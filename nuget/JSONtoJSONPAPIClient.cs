...
namespace APIVerve.API.JSONtoJSONP
{
    ...
    /// <summary>
    /// Client for the JSONtoJSONP API
    /// </summary>
...
#endif
    {
        ...
        {
            { "json", new ValidationRule { Type = "string", Required = true } },
            { "callback", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        private void ValidateParams(JSONtoJSONPQueryOptions options)
        {
