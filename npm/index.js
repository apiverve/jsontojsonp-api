...
class jsontojsonpWrapper {
    ...
    constructor(options) {
        ...
        this.validationRules = {"json":{"type":"string","required":true},"callback":{"type":"string","required":false,"default":"callback"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/jsontojsonp`);
        }
    }
...
module.exports = jsontojsonpWrapper;
