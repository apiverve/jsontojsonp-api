# JSON to JSONP API - Examples

This folder contains example code for using the JSON to JSONP API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/jsontojsonp',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/jsontojsonp");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/jsontojsonp](https://docs.apiverve.com/ref/jsontojsonp)
