/*
 * JSON to JSONP API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the JSON to JSONP API.
 * API Documentation: https://docs.apiverve.com/ref/jsontojsonp
 */
    ...
    class JSONtoJSONPExample
    {
        ...
        static async Task<JsonDocument> CallJSONtoJSONPAPI()
        {
            try
            {
                ...
                // Request body
                var requestBody &#x3D; new { callback &#x3D; &quot;callbackFunction&quot;, json &#x3D; [object Object] };
        ...
        {
            Console.WriteLine("📤 Calling JSON to JSONP API...\n");

            var result = await CallJSONtoJSONPAPI();
