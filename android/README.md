...
```gradle
dependencies {
    implementation 'com.github.apiverve:jsontojsonp-api:1.1.12'
}
```
...
```java
import com.apiverve.jsontojsonp.JSONtoJSONPAPIClient;
import com.apiverve.jsontojsonp.APIResponse;
import com.apiverve.jsontojsonp.APIException;

// Initialize the client
JSONtoJSONPAPIClient client = new JSONtoJSONPAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/jsontojsonp](https://docs.apiverve.com/ref/jsontojsonp)
...
- **Documentation:** [https://docs.apiverve.com/ref/jsontojsonp](https://docs.apiverve.com/ref/jsontojsonp)
- **Issues:** [GitHub Issues](https://github.com/apiverve/jsontojsonp-api/issues)
